...
document.addEventListener('DOMContentLoaded', function(){
  ...
  const i18n = {
    bn: {
      ...
      compiled_by: "সংকলন: <strong>Md. Mohsin Hossain</strong>, সিনিয়র রিসার্চ অ্যাসোসিয়েট",
      footer_contact: "প্রতিক্রিয়া বা আপডেট সংস্করণ সম্পর্কে জানতে বা জানাতে ইমেইল করুন: <a href=\"mailto:mohsin.hossain@bracu.ac.bd\">mohsin.hossain@bracu.ac.bd</a>. উৎস উল্লেখ করে পুনর্বণ্টন করা যাবে।",      site_link: "ওয়েবসাইট: https://mdmohsinhossain.github.io/",
      site_link_aria: "Md. Mohsin Hossain-এর ওয়েবসাইট খুলুন",      license: "লাইসেন্স: CC BY 4.0 (প্রস্তাবিত)",
    ...
    en: {
      ...
      compiled_by: "Compiled by: <strong>Md. Mohsin Hossain</strong> Senior Research Associate",
      ...
      site_link: "Website: https://mdmohsinhossain.github.io/",

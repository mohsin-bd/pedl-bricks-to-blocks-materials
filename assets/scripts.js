...
document.addEventListener('DOMContentLoaded', function(){
  ...
  const i18n = {
    bn: {
      ...
      footer_contact: "প্রতিক্রিয়া বা আপডেট সংস্করণ সম্পর্কে জানতে বা জানাতে ইমেইল করুন: <a href=\"mailto:mohsin.hossain@bracu.ac.bd\">mohsin.hossain@bracu.ac.bd</a>. উৎস উল্লেখ করে পুনর্বণ্টন করা যাবে।",
